...
if (strpos($_SERVER['SERVER_NAME'],'csit.rmit.edu.au')!==false) {
  echo "*** USE THE DEBUG MODULE ON CORETEACHING SERVERS ***<br>*** INSTRUCTIONS IN THE ASSIGNMENT DOCUMENT ***";
  die();
} 
...
/* Debug Lite:
   ...
   Only use on locally hosted or protected cloud environments such as cloud9 private environments
*/
  ...
  {
    echo "You are not authorised to view this page's PHP code";
  }
